			    ...
			    return o = {}, r.m = n = [function(t, e) {
			        ...
			        var m = (function(t, e) {
			            ...
			            value: function(t) {
			                ...
			                var classname = this.text(e).toString();
			                angular.element(document).find(".rotation_show_"+classname).addClass("rotating-border");
			                angular.element(document).find(".copymsg_"+classname).removeClass("hide");

		                    setTimeout(function(){
		                    angular.element(document).find(".copymsg_"+classname).addClass("hide");
		                    angular.element(document).find(".rotation_show_"+classname).removeClass("rotating-border");
		                    }, 3000);
