...
<div class="fontWrp">
	<section class="prdDtails pt-50 pb-50 text-center">
			<div class="container">
					<div class="inrWrp ">
						...
						<h1>Conversational Spanish Club (Zero Experience with Spanish) (A0 Level)</h1>
		...
		<div class="container">
			...
			<div class="inrWrp dFlx">		
				<div class="classtpRght">
					<div id="light" class="videoWrapPop">
					    <a class="boxclose" id="boxclose" onclick="lightbox_close();"><img src="/wp-content/uploads/2023/01/close-menu.png" alt=""></a>
					...
					<div class="icons">
					   <a href="#" class="" onclick="lightbox_open();"> 
					   		<div class="clkImg">
								<img src="/wp-content/uploads/2023/01/stud.jpg" alt="">				   			
					   		</div>
					   </a>
					</div>
				</div>
				...
				<div class="classtpLft">
					<p>Focusing on everyday words, get the chance to practice using them in casual conversation club. Listening comprehension and confidence SPEAKING from class one - in every class a new theme. Base our conversation on a video story on teens. </p>
				<!-- 	<div class="othrCls dFlx">
						<a href="" class="dFlx">
							<div class="icnWrp">
								<img src="/wp-content/uploads/2023/01/schl.png" alt="">
							</div>
					...
					<div class="strw1 dFlx">
						<div class="strw1star ">
							<img src="/wp-content/uploads/2023/01/starR.png" alt="">
						</div>
					...
					<div class="classSchdl dFlx">
						<div class="btnclw">
							<a href="#availableTime" class="newBtn01">See Class Schedule <i class="fa fa-angle-right"></i></a>
						</div>
	        ...
	        <div class="ongoingCrs dFlx">
	        	...
	        	<div class="ongoingCrsRght text-center">
	        		<div class="eachLear">
	        			<h2>₹1,544 <span> INR</span> </h2>
	        			<p>₹1,544/class for each learner </p>
	        		</div>
	        	</div> 
	        	...
	        	<div class="ongoingCrsLft dFlx">
	        		<div class="ongoingCrsWrp dFlx">
	        			<div class="iconWrp">
	        				<img src="/wp-content/uploads/2023/01/1-1-1.png" alt="">
	        			</div>
	        			<div class="ongoingInfo dFlx">
	        				<h3 class="ongoingDrop">Ongoing Course </h3>		
	        			</div>        		
	        		</div>
	        		<div class="ongoingCrsWrp dFlx">
	        			<div class="iconWrp">
	        				<img src="/wp-content/uploads/2023/01/4-1-1.png" alt="">
	        			</div>
	        			<div class="ongoingInfo dFlx">
	    	    			<h3>50 minutes </h3> <p>per class</p>
		        		</div>
	        		</div>
	        		<div class="ongoingCrsWrp dFlx">
	        			<div class="iconWrp">
	        				<img src="/wp-content/uploads/2023/01/2-1-1.png" alt="">
	        			</div>
	        			<div class="ongoingInfo dFlx">
	        				<h3>Once per week </h3> <p>every week</p>
	        			</div>
	        		</div>
	        		<div class="ongoingCrsWrp dFlx">
	        			<div class="iconWrp">
	        				<img src="/wp-content/uploads/2023/01/5-1-1.png" alt="">
	        			</div>
	        			<div class="ongoingInfo dFlx">
	    	    			<h3>12-17 </h3> <p>year old learners</p>
		        		</div>
	        		</div>
	        		<div class="ongoingCrsWrp dFlx">
	        			<div class="iconWrp">
	        				<img src="/wp-content/uploads/2023/01/3-1-1.png" alt="">
	        			</div>
	        			<div class="ongoingInfo dFlx">
	    	    			<h3>1-6 </h3> <p>learners per class</p>
		        		</div>
	        		</div>        	
	        	...
	        	<div class="cousrDtailT dFlx">	        		
	        		<div class="RghtCsrDtailT">
	        			<div class="vdoTWrp">
	        				<video controls autoplay>
							  <source src="/wp-content/uploads/2023/01/videoplayback.mp4" type="video/mp4">							  
							  Your browser does not support the video tag.
							</video>
	        			</div>
	        		</div>
	        		<div class="LeftCsrDtailT">
	        			<h3>How does an "Ongoing" course work?</h3>
	        			<ul>
	        				<li><i aria-hidden="true" class="fas fa-check"></i> Meets on a weekly schedule, join any week, no need to catch up on previous material </li>
	        				<li><i aria-hidden="true" class="fas fa-check"></i> Live video chats, recorded and monitored for safety and quality </li>
	        				<li><i aria-hidden="true" class="fas fa-check"></i> Discussions via classroom forum and private messages with the teacher </li>
	        				<li><i aria-hidden="true" class="fas fa-check"></i> Automatic payment every Sunday, cancel any time </li>
	        				<li><i aria-hidden="true" class="fas fa-check"></i> Great for clubs and for practicing skills </li>
	        			</ul>
	        		</div>
	        	</div>
	...
	<section class="availablTime" id="availableTime">
		<div class="container">
				...
				<div class="abailablSldr owl-carousel">
					<div class="item">
						<div class="ItmWrp"> 
							...
							<div class="txtInp">
								<p>7 learners enrolled</p>
							</div>
							<div class="sbscrb">
								<span class="sbscrbBtn">Subscribe</span>
							</div>
						</div>					
					</div>
					<div class="item">
	...
	<section class="descrptionWrp pt-60 pb-50">
		<div class="container">
			...
			<div class="askQtn">
				<p class="qustnWrp newBtn modal-toggle6"> Ask a Question </p>
			</div>
...
<!-- 	<section class="rViewWrp pt-60 pb-60">
	...
	<section class="othrClasWrp">
		<div class="container">
			<h2 class="text-center">Other classes by Bonjour Tutors </h2>

			<div class="othrClasWrpSldr">
				<div class="owl-carousel  othrClaSlider cmnSlider">
				    <div class="item">
					    <div class="slidItem">
							<a href="" class="crseItem">
								<div class="topImg">
									<img src="/wp-content/uploads/2023/01/image01.jpg" alt="">
								</div>
								<div class="crseInfo">
									<div class="starInfo dFlx">
										<div class="strRatng dFlx">
											<div class="starWrp">
												<img src="/wp-content/uploads/2023/01/star.png" alt="">
											</div>
											<div class="rateInfo">
										...
										<div class="strLike">
											<div class="like">
												<img src="/wp-content/uploads/2023/01/like.png" alt="">
											</div>
										</div>
									</div>
									<div class="txtWrap">
									...
									<div class="tutrInfo dFlx">
										<div class="imgWrp">
											<img src="/wp-content/uploads/2023/01/usr.png" alt="">
										</div>
				    ...
				    <div class="item">
					    <div class="slidItem">
							<a href="" class="crseItem">
								<div class="topImg">
									<img src="/wp-content/uploads/2023/01/image02.jpg" alt="">
								</div>
								<div class="crseInfo">
									<div class="starInfo dFlx">
										<div class="strRatng dFlx">
				    ...
				    <div class="item">
					    <div class="slidItem">
							<a href="" class="crseItem">
								<div class="topImg">
									<img src="/wp-content/uploads/2023/01/image03.jpg" alt="">
								</div>
								<div class="crseInfo">
									<div class="starInfo dFlx">
										<div class="strRatng dFlx">
				    ...
				    <div class="item">
					    <div class="slidItem">
							<a href="" class="crseItem">
								<div class="topImg">
									<img src="/wp-content/uploads/2023/01/image04.jpg" alt="">
								</div>
								<div class="crseInfo">
									<div class="starInfo dFlx">
										<div class="strRatng dFlx">
				    ...
				    <div class="item">
					    <div class="slidItem">
							<a href="" class="crseItem">
								<div class="topImg">
									<img src="/wp-content/uploads/2023/01/image05.jpg" alt="">
								</div>
								<div class="crseInfo">
									<div class="starInfo dFlx">
										<div class="strRatng dFlx">
	...
	<section class="popTopics pt-60 pb-50">
