...
use App\Http\Controllers\Api\User\DailyResponseController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('daily-journal')->group(function () {
		...
		Route::get("/daily-submit", [DailyJournalController::class, "dailySubmit"]);
        ...
        Route::post("/store-ans", [DailyJournalController::class, "storeQueAns"])
            ->middleware("plan_check:daily_journal");
        Route::post("/", [DailyJournalController::class, "store"]);
        Route::delete("/{response}", [DailyJournalController::class, "destroy"]);
    });
	Route::prefix('daily-response')->group(function () {
		Route::get("/", [DailyResponseController::class, "index"]);
        Route::get("/daily-submit", [DailyResponseController::class, "dailySubmit"]);
    });
    ...
    Route::prefix('self-assessment')->group(function () {
        ...
        Route::get("/daily-submit", [SelftAssessmentController::class, "dailySubmit"]);
        ...
        Route::post("/store-ans", [SelftAssessmentController::class, "storeQueAns"])
            ->middleware("plan_check:self_assessment");
    });
