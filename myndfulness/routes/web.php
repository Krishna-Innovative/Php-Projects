...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::prefix('q-group')->group(function () {
        ...
        Route::get('/q-set', 'QuestionSetController@index')->name('questions-set.index');
          Route::get('/getSets', 'QuestionSetController@getSets');

        Route::get('/add-q-set', 'QuestionSetController@add')->name('questions-set.add');
    // });
    Route::prefix('group-questions')->group(function () {
     ...
     Route::prefix('set-questions')->group(function () {
        Route::get('/{group_id}', 'SetQuestionController@index')->name('set-questions.index');
        Route::post('/store', 'SetQuestionController@store');
        // Route::get('/add-questions-group','QuestionGroupController@add')->name('group-questions.add');
    });


    Route::get('/dashboard', 'HomeController@dashboard')->middleware(['auth'])->name('dashboard');
	Route::get('/subscriber', 'HomeController@planlist')->middleware(['auth'])->name('planlist');
