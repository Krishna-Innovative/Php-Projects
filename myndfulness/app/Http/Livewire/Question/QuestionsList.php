...
class QuestionsList extends Component
{
    ...
    public function confirmDelete($question_id){ //echo $question_id.'dsghfgh';die("vnjfnvjnfjnfj");
        try {
            $question = Question::find($question_id);
            $options = QuestionOption::where('id',$question_id)->delete();
			$questionsetQuestions = QuestionSetQuestion::where("question_id",$question_id)->delete();
            $question->delete();
