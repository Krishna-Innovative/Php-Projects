                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <button wire:click="$emitTo('question-set.edit-question-set','setQset',{{$group}})" data-toggle="modal" data-target="#edit-set" type="button" class="btn btn-outline-primary btn-sm" title="Edit"><i class="mdi mdi-table-edit"></i></button>
                                <a href="{{route('set-questions.index',['group_id' => $group->id])}}" class="btn btn-outline-primary btn-sm">Questions <i class="mdi mdi-comment-question-outline"></i></a>
