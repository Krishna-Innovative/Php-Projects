<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="group-questions">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('questions-set.index') }}">Manage Question Set </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('questions-set.add') }}"> Add Question Set</a></li>
              </ul>
            </div>
        </li>
		...
		<li class="nav-item">
            <a class="nav-link" href="{{ route('planlist') }}">
