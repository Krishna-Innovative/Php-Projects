<?php
/*Template name: bee-smart-biannual*/
get_header();
?>
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() ?>/styles/subscription.css">
			...
			<div class="step well">
				...
				<div class="section_cart cart_page">
					...
					<div class="select_membership">
						<h4 class="smart">Bee <br /> Smart</h4>
						<p class="plan_name">
							<span>$9.6 per months</span>
