				...
				<div class="user-detail">
					...
					<div class="user_icon">
						<!-- <img src="<?php //echo site_url(); 
										?>/wp-content/uploads/2022/02/dont.png" class="d-none">
						<img src="<?php //echo site_url(); 
						...
						<div class="row m-0 align-items-center">
							<div class="col-5 pl-0">
								<div class="login_tabform">
									<input type="text" class="form-control mb-1" placeholder="Emial" />
									<input type="password" class="form-control" placeholder="Password" />
									<a href="#" class="restpwd">Reset password</a>
								</div>
							</div>
							<div class="col-2 p-0 text-center">
								<h4>Sign In</h4>
								<button class="btn login_btn p-0" type="button">
									<img width="55" src="<?php echo site_url(); ?>/wp-content/uploads/2022/01/Check1.png" class="hover_hue">
								</button>
							</div>
							<div class="col-5 pr-0">
								<a href="#" class="signup_btn">Create <br>new profile</a>
							</div>
