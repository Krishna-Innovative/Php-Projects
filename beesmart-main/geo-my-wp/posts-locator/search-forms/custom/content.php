...
?>
<style>
.single_step.focus_step a img:hover,
.single_step.type_step a img:hover,
.single_step.find_step a img:hover {
    transform: scale(1.2);
}
.single_step.focus_step a img,
.single_step.type_step a img,
.single_step.find_step a img {
								...
								<div class="single_step info_step text-center mb-5 active">
									...
									<a href="#" class="item item7">
										...
										<?php// if ( ! empty( $country_list ) && is_array( $country_list ) ) { ?>
										  <div class="niceCountryInputSelector info_select info_country" style="width: 300px;" data-selectedcountry="all" data-showspecial="false" data-showflags="true" data-i18nall="All selected" data-i18nnofilter="No selection" data-i18nfilter="Filter" data-onchangecallback="onChangeCallback" ></div>
										...
										if ( ! empty( $languages ) && is_array( $languages ) ) { ?>
											<select multiple class="form-control info_select info_language selectpicker" data-live-search="true">
												<?php foreach ( $languages as $language ) { 
													//echo $languages_option[$loop].'wewewe';
