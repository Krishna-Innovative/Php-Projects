...
<div class="gmw-results-wrapper 34546457347 grid-gray gmw-pt-grid-gray-results-wrapper <?php echo esc_attr( $gmw['prefix'] ); ?>" data-id="<?php echo absint( $gmw['ID'] ); ?>" data-prefix="<?php echo esc_attr( $gmw['prefix'] ); ?>">
						...
						<div class="wrapper-inner">
							...
							<div class="post-content"> 
								...
								<div class="type-of-post">
									<?php the_field('Choose-Type'); ?>
									<?php// the_field('Language'); ?>
								</div>
							</div>
							<?php //echo do_shortcode( '[CUSTOM_POST_POPUP type="post" orderby="none" posts_per_page="12" customclass="custom class"]' ); ?>
							...
							<div class="card-wrapper">
								...
								<div class="bees-block">
									...
									<img src="https://beesm.art/wp-content/uploads/2021/11/Bees4.png" alt="comments">
								</div>
						</div>
							</div>
					</li><!-- #post -->
