...
<?php if ( have_comments() && ! empty( $comments_by_type['comment'] ) ) : ?>
	...
	<div class="comments-count">
		<img src="https://staging2.beesm.art/wp-content/uploads/2021/11/Bees.svg" alt="">
	...
	<?php if ('open' === $post->comment_status) : ?>
		<?php comment_form( array('label_submit' => esc_attr__( 'Submit', 'Divi' ), 'title_reply' => '<span>' . esc_attr__( 'Submit a Comment', 'Divi' ) . '</span>', 'title_reply_to' => esc_attr__( 'Leave a Reply to %s', 'Divi' ), 'class_submit' => 'submit et_pb_button' ) ); ?>
	<?php else: ?>
